# Universal above-the-fold optimization (FIXED with (?is) flag for h1)
...
# FIXED: use (?is) flag for h1 matching (newlines in content)
...
foreach ($f in $allHtml) {
  ...
  # Already within 800 chars of target position
